...
!http://i.imgur.com/foTzIz4.png(I do not endorse the use of heavy appliances as self-aware entities)!
...
The _*code*_ for the Tweeting process is incredibly straightforward. [Using the Twython library]
...
!http://i.imgur.com/a2Qtjek.png("Oh!  That?  Yeah that was me.  Speaking of which do you know where the knife block went?")!
...
%{font-size:9pt}**I plan on putting the full script for both training and recognition on Github. The code is incredibly useless for anyone not using my apartment kitchen, since most is just hardcoded values tuned to the environment and camera angle, but it could be handy for reference I suppose.%
